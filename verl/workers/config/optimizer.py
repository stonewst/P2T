...
class FSDPOptimizerConfig(OptimizerConfig):
    ...
    Args:
        ...
        warmup_style (str): LR warmup style: "constant", "cosine", or "wsd".
        num_cycles (float): Number of cosine cycles in LR schedule.
        stable_ratio (float): Stable ratio for wsd scheduler (warmup-stable-decay).
    """
    ...
    def __post_init__(self):
        assert self.warmup_style in ["constant", "cosine", "wsd"]
